...
public sealed class WorkflowContractTests
{
    ...
    private static string FindRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "Maliev.QuotationService.slnx")))
            {
                return directory.FullName;
            }
        }

        throw new DirectoryNotFoundException("Could not locate QuotationService repository root.");
    }
}
