        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contact_info = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                    merged_from_ids = table.Column<List<Guid>>(type: "uuid[]", nullable: true),
                    merge_history = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    physical_properties = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                    mechanical_properties = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    material_service_id = table.Column<Guid>(type: "uuid", nullable: false),
                    material_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    material_properties = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    billing_identity_type = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delivery_expectations = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<int>(type: "integer", nullable: false),
                    request_details = table.Column<JsonDocument>(type: "jsonb", nullable: true),
