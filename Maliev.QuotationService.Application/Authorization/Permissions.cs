...
{
    /// <summary>Permission to create new quotations.</summary>
    public const string QuotationsCreate = "quotation.quotations.create";
    /// <summary>Permission to read quotation details.</summary>
    public const string QuotationsRead = "quotation.quotations.read";
    /// <summary>Permission to update quotation information.</summary>
    public const string QuotationsUpdate = "quotation.quotations.update";
    /// <summary>Permission to delete quotations.</summary>
    ...
    /// <summary>Permission to send quotations to customers.</summary>
    public const string QuotationsSend = "quotation.quotations.send";
    /// <summary>Permission to convert quotation to order.</summary>
    public const string QuotationsConvert = "quotation.quotations.convert";
    /// <summary>Permission to create revised versions of quotations.</summary>
    public const string QuotationsRevise = "quotation.quotations.revise";
    /// <summary>Permission to mark quotations as expired.</summary>
    public const string QuotationsExpire = "quotation.quotations.expire";

    /// <summary>Permission to create quotation line items.</summary>
    ...
    /// <summary>Permission to create quotation templates.</summary>
    ...
    /// <summary>Permission to use templates for quotations.</summary>
